...
use std::path::Path;
use wow_alchemy_adt::{Adt, AdtVersion, ValidationLevel};
...
fn execute_extract(
    ...
    use wow_alchemy_adt::extract::{HeightmapOptions, ImageFormat, extract_heightmap};
    ...
    if textures {
        use wow_alchemy_adt::extract::extract_textures;
    ...
    // Extract model placements
    if models {
        use wow_alchemy_adt::extract::extract_models;

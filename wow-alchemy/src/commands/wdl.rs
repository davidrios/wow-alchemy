...
use wow_alchemy_wdl::validation::validate_wdl_file;
...
fn execute_convert(
    ...
    // Convert the file
    let converted_file = wow_alchemy_wdl::conversion::convert_wdl_file(&wdl_file, target_version)
...
fn execute_tree(
    ...
    let mut chunk_groups: std::collections::BTreeMap<String, Vec<&wow_alchemy_wdl::types::Chunk>> =

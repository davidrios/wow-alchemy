...
impl From<BlpVersionCli> for wow_alchemy_blp::types::BlpVersion {
    fn from(value: BlpVersionCli) -> Self {
        match value {
            BlpVersionCli::Blp0 => wow_alchemy_blp::types::BlpVersion::Blp0,
            BlpVersionCli::Blp1 => wow_alchemy_blp::types::BlpVersion::Blp1,
            BlpVersionCli::Blp2 => wow_alchemy_blp::types::BlpVersion::Blp2,
        }
    }
}
...
fn make_blp_target(
    ...
    use wow_alchemy_blp::types::BlpVersion;

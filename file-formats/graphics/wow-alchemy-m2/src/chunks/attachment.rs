...
pub enum M2AttachmentId {
    ...
    SheathMainHand = 26,
    #[wow_alchemy_data(expr = 27)]
    SheathOffHand = 27,
    #[wow_alchemy_data(expr = 28)]
    SheathShield = 28,
    #[wow_alchemy_data(expr = 29)]
    PlayerNameMounted = 29,
    #[wow_alchemy_data(expr = 30)]
    LargeWeaponLeft = 30,
    #[wow_alchemy_data(expr = 31)]
    LargeWeaponRight = 31,
    #[wow_alchemy_data(expr = 32)]
    HipWeaponLeft = 32,
    #[wow_alchemy_data(expr = 33)]
    HipWeaponRight = 33,
    #[wow_alchemy_data(expr = 34)]
    Chest = 34,
    #[wow_alchemy_data(expr = 35)]
    HandArrow = 35,
    #[wow_alchemy_data(expr = 36)]
    Bullet = 36,
    #[wow_alchemy_data(expr = 37)]
    SpellHandOmni = 37,
    #[wow_alchemy_data(expr = 38)]
    SpellHandDirected = 38,
    #[wow_alchemy_data(expr = 39)]
    VehicleSeat1 = 39,
    #[wow_alchemy_data(expr = 40)]
    VehicleSeat2 = 40,
    #[wow_alchemy_data(expr = 41)]
    VehicleSeat3 = 41,
    #[wow_alchemy_data(expr = 42)]
    VehicleSeat4 = 42,
    #[wow_alchemy_data(expr = 43)]
    VehicleSeat5 = 43,
    #[wow_alchemy_data(expr = 44)]
    VehicleSeat6 = 44,
    #[wow_alchemy_data(expr = 45)]
    VehicleSeat7 = 45,
    #[wow_alchemy_data(expr = 46)]
    VehicleSeat8 = 46,
    #[wow_alchemy_data(expr = 47)]
    LeftFoot = 47,
    #[wow_alchemy_data(expr = 48)]
    RightFoot = 48,
    #[wow_alchemy_data(expr = 49)]
    ShieldNoGlove = 49,
    #[wow_alchemy_data(expr = 50)]
    SpineLow = 50,
    #[wow_alchemy_data(expr = 51)]
    AlteredShoulderR = 51,
    #[wow_alchemy_data(expr = 52)]
    AlteredShoulderL = 52,
    #[wow_alchemy_data(expr = 53)]
    BeltBuckle = 53,
    #[wow_alchemy_data(expr = 54)]
    SheathCrossbow = 54,
    #[wow_alchemy_data(expr = 55)]
    HeadTop = 55,
    #[wow_alchemy_data(expr = 56)]
    VirtualSpellDirected = 56,
    #[wow_alchemy_data(expr = 57)]
    Backpack = 57,
    #[wow_alchemy_data(expr = 58)]
    Unknown = 60,
}
...
#[wow_alchemy_data(version = MD20Version, header = M2AttachmentHeader)]
